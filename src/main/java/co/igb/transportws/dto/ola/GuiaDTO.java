...
public class GuiaDTO {
    ...
    public String getVlrmcia() {
        return vlrmcia;
    }

    public void setVlrmcia(String vlrmcia) {
        this.vlrmcia = vlrmcia;
    }
    ...
    public String getNitr() {
        return nitr;
    }

    public void setNitr(String nitr) {
        this.nitr = nitr;
    }
    ...
    public void setNitd(String nitd) {
        this.nitd = nitd;
    }
