...
public class OrderRestDTO implements Serializable {
    ...
    public static class DocumentApprovalRequests implements Serializable {
        ...
        public List<DocumentApprovalRequest> getDocumentApprovalRequest() {
            if (documentApprovalRequest == null) {
                documentApprovalRequest = new ArrayList<DocumentApprovalRequest>();
            }
    ...
    public static class DocumentLines implements Serializable {
        ...
        public static class DocumentLine implements Serializable {
            ...
            public static class BatchNumbers implements Serializable {
                ...
                protected List<BatchNumber> batchNumber;

                public List<BatchNumber> getBatchNumber() {
                    if (batchNumber == null) {
                        batchNumber = new ArrayList<BatchNumber>();
                    }
            ...
            public static class DocumentLineAdditionalExpenses implements Serializable {
                ...
                protected List<DocumentLineAdditionalExpense> documentLineAdditionalExpense;

                public List<DocumentLineAdditionalExpense> getDocumentLineAdditionalExpense() {
                    if (documentLineAdditionalExpense == null) {
                        documentLineAdditionalExpense = new ArrayList<DocumentLineAdditionalExpense>();
                    }
                ...
                public static class DocumentLineAdditionalExpense implements Serializable {
                    ...
                    public static class LineExpenseTaxJurisdictions implements Serializable {
                        ...
                        protected List<LineExpenseTaxJurisdiction> lineExpenseTaxJurisdiction;
            ...
            public static class DocumentLinesBinAllocations implements Serializable {
                ...
                protected List<DocumentLinesBinAllocation> documentLinesBinAllocation;

                public List<DocumentLinesBinAllocation> getDocumentLinesBinAllocation() {
                    if (documentLinesBinAllocation == null) {
                        documentLinesBinAllocation = new ArrayList<DocumentLinesBinAllocation>();
                    }
            ...
            public static class LineTaxJurisdictions implements Serializable {
                ...
                protected List<LineTaxJurisdiction> lineTaxJurisdiction;

                public List<LineTaxJurisdiction> getLineTaxJurisdiction() {
                    if (lineTaxJurisdiction == null) {
                        lineTaxJurisdiction = new ArrayList<LineTaxJurisdiction>();
                    }
            ...
            public static class WithholdingTaxLines implements Serializable {
                ...
                protected List<WithholdingTaxLine> withholdingTaxLine;

                public List<WithholdingTaxLine> getWithholdingTaxLine() {
                    if (withholdingTaxLine == null) {
                        withholdingTaxLine = new ArrayList<WithholdingTaxLine>();
                    }
    ...
    public static class ElectronicProtocols implements Serializable {
        ...
        protected List<ElectronicProtocol> electronicProtocol;

        public List<ElectronicProtocol> getElectronicProtocol() {
            if (electronicProtocol == null) {
                electronicProtocol = new ArrayList<ElectronicProtocol>();
            }
    ...
    public static class DocumentAdditionalExpenses implements Serializable {
        ...
        protected List<DocumentAdditionalExpense> documentAdditionalExpense;

        public List<DocumentAdditionalExpense> getDocumentAdditionalExpense() {
            if (documentAdditionalExpense == null) {
                documentAdditionalExpense = new ArrayList<DocumentAdditionalExpense>();
            }
        ...
        public static class DocumentAdditionalExpense implements Serializable {
            ...
            public static class DocExpenseTaxJurisdictions implements Serializable {
                ...
                protected List<DocExpenseTaxJurisdiction> docExpenseTaxJurisdiction;

                public List<DocExpenseTaxJurisdiction> getDocExpenseTaxJurisdiction() {
                    if (docExpenseTaxJurisdiction == null) {
                        docExpenseTaxJurisdiction = new ArrayList<DocExpenseTaxJurisdiction>();
                    }
    ...
    public static class WithholdingTaxDataWTXCollection implements Serializable {
        ...
        protected List<WithholdingTaxDataWTX> withholdingTaxDataWTX;

        public List<WithholdingTaxDataWTX> getWithholdingTaxDataWTX() {
            if (withholdingTaxDataWTX == null) {
                withholdingTaxDataWTX = new ArrayList<WithholdingTaxDataWTX>();
            }
    ...
    public static class WithholdingTaxDataCollection implements Serializable {
        ...
        protected List<WithholdingTaxData> withholdingTaxData;

        public List<WithholdingTaxData> getWithholdingTaxData() {
            if (withholdingTaxData == null) {
                withholdingTaxData = new ArrayList<WithholdingTaxData>();
            }
    ...
    public static class DocumentSpecialLines implements Serializable {
        ...
        protected List<DocumentSpecialLine> documentSpecialLine;

        public List<DocumentSpecialLine> getDocumentSpecialLine() {
            if (documentSpecialLine == null) {
                documentSpecialLine = new ArrayList<DocumentSpecialLine>();
            }
