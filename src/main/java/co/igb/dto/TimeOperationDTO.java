...
public class TimeOperationDTO {
    ...
    public TimeOperationDTO() {
    }

    public TimeOperationDTO(Integer year, Integer month, String nameMonth, String userName, Integer timeEstCargaS, BigDecimal timeRealCargaS, Integer timeEstContainer, BigDecimal timeRealContainer) {
        this.year = year;
        this.month = month;
