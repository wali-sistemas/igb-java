...
public class TimeLiquidDTO {
    ...
    public TimeLiquidDTO() {
    }

    public TimeLiquidDTO(Integer year, Integer month, String nameMonth, String userName, Integer timeEstCargaS, BigDecimal timeRealCargaS, Integer timeEstContainer, BigDecimal timeRealContainer) {
        this.year = year;
        this.month = month;
