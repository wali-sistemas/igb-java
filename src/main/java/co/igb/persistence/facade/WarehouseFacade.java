...
public class WarehouseFacade {
    ...
    public List<WarehouseDTO> listBinEnabledWarehouses(String companyName, boolean testing) {
        ...
        sb.append("select cast(\"WhsCode\" as varchar(15))as code,cast(\"WhsName\" as varchar(100))as name,cast(\"DftBinAbs\" as int)as dftBinAbs from OWHS where \"BinActivat\"='Y' and \"Block\"<>'Y' order by \"U_VLGX_OF\" ASC");
        try {
