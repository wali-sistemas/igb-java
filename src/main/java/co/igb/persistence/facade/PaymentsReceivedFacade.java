...
public class PaymentsReceivedFacade {
    ...
    public List<Object[]> getCollectMonthly(String companyName, boolean testing) {
        ...
        sb.append("   from ( ");
        sb.append("    select distinct f.\"DocDueDate\" as \"fechaVenc\",cast(d.\"AppliedSys\" as int) as \"Valor\",cast(r.\"DocDate\" as date) as \"fechaRecibo\",DAYS_BETWEEN(f.\"DocDueDate\",r.\"DocDate\")as \"diasAtraso\" ");
        ...
        sb.append("   union all ");
        sb.append("    select distinct n.\"DocDueDate\" as \"fechaVenc\",cast(d.\"AppliedSys\" as int) as \"Valor\",cast(r.\"DocDate\" as date) as \"fechaRecibo\",DAYS_BETWEEN(n.\"DocDueDate\",r.\"DocDate\")as \"diasAtraso\" ");
        sb.append("    from ORCT r ");
        sb.append("    inner join RCT2 d on r.\"DocEntry\" = d.\"DocNum\" ");
        sb.append("    inner join OJDT j on r.\"TransId\" = j.\"TransId\" ");
        sb.append("    inner join JDT1 t on j.\"TransId\" = t.\"TransId\" ");
        ...
        sb.append("   union all ");
        sb.append("    select distinct f.\"TaxDate\" as \"fechaVenc\",cast(d.\"AppliedSys\" as int) as \"Valor\", cast(r.\"DocDate\" as date) as \"fechaRecibo\",DAYS_BETWEEN(f.\"TaxDate\",r.\"DocDate\")as \"diasAtraso\" ");
        sb.append("    from ORCT r ");
        sb.append("    inner join OJDT j on r.\"TransId\" = j.\"TransId\" ");
